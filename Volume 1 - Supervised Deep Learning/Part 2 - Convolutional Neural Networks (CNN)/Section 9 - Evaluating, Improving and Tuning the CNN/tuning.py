# -*- coding: utf-8 -*-
"""
Created on Fri Apr 10 18:52:34 2020
...
training_set_path = os.path.join(script_dir, 'dataset/test_set')
...
loss_history_path = os.path.join(script_dir, 'dataset/loss_history.log')
